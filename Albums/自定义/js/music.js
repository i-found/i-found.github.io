...
var data=[
            {
                ...
                singer:"许嵩",
                src:"mp3/许嵩 - 有何不可.m4a",
                img:'css/img/有何不可cover.png',
                lyric:'有何不可'
            },
            {
                song:"多余的解释",
                singer:"许嵩",
                src:"mp3/许嵩 - 多余的解释.m4a",
                img:'css/img/多余的解释cover.png',
                lyric:'多余的解释'
            },
            {
                song:"清明雨上",
...
///////////////////////<--------事件区--------->//////////////////////////////////////////
    ...
    oListMask.onclick=function () {
        ...
        move(playList,{bottom:-430},200,'easeIn');
    };
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        span.innerHTML=data[i].singer+" | 自定义";
        li.appendChild(span);
        ul.appendChild(li);
    }
    ...
    loop.onclick=function(){
        //列表循环
        if(this.onOff){
            this.style.background='url(css/img/play_icn_loop_solo.png)';
            this.onOff=false;
        //单曲循环
        }else{
            this.style.background='url(css/img/play_icn_loop.png)';
            this.onOff=true;
        }
    };
    //12.歌词初始化
